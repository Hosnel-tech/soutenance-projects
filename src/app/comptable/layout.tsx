  ...
  const navigation = [
    {
      ...
      current: pathname === "/comptable/dashboard",
    },
    {
      name: "Finance",
      href: "/comptable/finance",
      icon: DollarSign,
      current: pathname === "/comptable/finance",
    },
    // {
    //   name: "Facturation",
    //   href: "/comptable/facturation",
    //   icon: Receipt,
    //   current: pathname === "/comptable/facturation",
    // },
    // {
    //   name: "Comptabilité",
    //   href: "/comptable/comptabilite",
    //   icon: Calculator,
    //   current: pathname === "/comptable/comptabilite",
    // },
    // {
    //   name: "Clients",
    //   href: "/comptable/clients",
    //   icon: Users,
    //   current: pathname === "/comptable/clients",
    // },
    // {
    //   name: "Rapports",
    //   href: "/comptable/rapports",
    //   icon: BarChart3,
    //   current: pathname === "/comptable/rapports",
    // },
    {
      name: "Paramètres",
      href: "/comptable/settings",
      icon: Settings,
      current: pathname === "/comptable/settings",
    },
  ];
